...
var grammar = {
    ...
    {"name": "B", "symbols": ["Map"], "postprocess": d => d[0]},
    ...
    {"name": "MapContents$macrocall$1$ebnf$2", "symbols": ["MapContents$macrocall$3"], "postprocess": id},
    {"name": "MapContents$macrocall$1$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "MapContents$macrocall$1", "symbols": ["MapContents$macrocall$1$ebnf$1", "MapContents$macrocall$2", "MapContents$macrocall$1$ebnf$2"], "postprocess": d => [...d[0].map(([x, y]) => x), d[1]]},
