...
var grammar = {
    ...
    {"name": "Statement", "symbols": ["AssignStatement"], "postprocess": d => d[0]},
    ...
    {"name": "AssignStatement", "symbols": [t_identifier, "_", t_equals, "_", "Expression"], "postprocess": d => ['assign', d[0], d[4]]},
    ...
    {"name": "FunctionDef", "symbols": ["FunctionDef$ebnf$1", "_", t_fat_arrow, "_", "Expression"], "postprocess":  ([ [ name, args ], ,,, body ]) =>
        [ name, args, body ]
          },
    ...
    {"name": "B", "symbols": ["Literal"], "postprocess": d => d[0]},
    {"name": "B", "symbols": ["IfConditional"], "postprocess": d => d[0]},
    {"name": "B", "symbols": ["MatchConditional"], "postprocess": d => d[0]},
    ...
    {"name": "Literal", "symbols": ["Identifier"], "postprocess": d => d[0]},
    {"name": "Literal", "symbols": ["Number"], "postprocess": d => d[0]},
    {"name": "Literal", "symbols": ["String"], "postprocess": d => d[0]},
    {"name": "Literal", "symbols": ["Bool"], "postprocess": d => d[0]},
    {"name": "Literal", "symbols": ["Map"], "postprocess": d => d[0]},
    ...
    {"name": "Map$ebnf$1", "symbols": ["MapContents"], "postprocess": id},
    {"name": "Map$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Map", "symbols": [t_open_square, "_", "Map$ebnf$1", "_", t_close_square], "postprocess": d => ['map', d[2] || []]},
    {"name": "MapContents$macrocall$2", "symbols": [t_identifier, "_", t_arrow, "_", "Expression"]},
    {"name": "MapContents$macrocall$3", "symbols": ["_", t_comma, "_"]},
    {"name": "MapContents$macrocall$1$ebnf$1", "symbols": []},
    {"name": "MapContents$macrocall$1$ebnf$1$subexpression$1", "symbols": ["MapContents$macrocall$2", "MapContents$macrocall$3"]},
    {"name": "MapContents$macrocall$1$ebnf$1", "symbols": ["MapContents$macrocall$1$ebnf$1", "MapContents$macrocall$1$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "MapContents$macrocall$1", "symbols": ["MapContents$macrocall$1$ebnf$1", "MapContents$macrocall$2"], "postprocess": d => [...d[0].map(([x, y]) => x), d[1]]},
    {"name": "MapContents", "symbols": ["MapContents$macrocall$1"], "postprocess": d => d[0].map(d => [ d[0], d[4] ])},
    ...
    {"name": "IfConditional", "symbols": [k_if, "nn", "Expression", "nn", k_then, "nn", "Expression", "nn", k_else, "nn", "Expression"], "postprocess": d => ['if_conditional', d[2], d[6], d[10], d[0]]},
    {"name": "MatchConditional", "symbols": [k_match, "nn", "Expression", "nn", k_where, "nn", "MatchConditionalContents"], "postprocess": d => ['match_conditional', d[2], d[6], d[0]]},
    {"name": "MatchConditionalContents$macrocall$2", "symbols": ["n", t_pipe, "n"]},
    {"name": "MatchConditionalContents$macrocall$3", "symbols": ["Literal", "_", t_arrow, "_", "Expression"]},
    {"name": "MatchConditionalContents$macrocall$1$ebnf$1$subexpression$1", "symbols": ["MatchConditionalContents$macrocall$2", "MatchConditionalContents$macrocall$3"]},
    {"name": "MatchConditionalContents$macrocall$1$ebnf$1", "symbols": ["MatchConditionalContents$macrocall$1$ebnf$1$subexpression$1"]},
    {"name": "MatchConditionalContents$macrocall$1$ebnf$1$subexpression$2", "symbols": ["MatchConditionalContents$macrocall$2", "MatchConditionalContents$macrocall$3"]},
    {"name": "MatchConditionalContents$macrocall$1$ebnf$1", "symbols": ["MatchConditionalContents$macrocall$1$ebnf$1", "MatchConditionalContents$macrocall$1$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "MatchConditionalContents$macrocall$1", "symbols": ["MatchConditionalContents$macrocall$1$ebnf$1"], "postprocess": d => d[0].map(([x, y]) => y)},
    {"name": "MatchConditionalContents", "symbols": ["MatchConditionalContents$macrocall$1"], "postprocess": d => d[0].map(d => [ d[2], d[6] ])},
    ...
    {"name": "n$ebnf$1$subexpression$1", "symbols": [t_whitespace]},
    {"name": "n$ebnf$1$subexpression$1", "symbols": [t_newline]},
    {"name": "n$ebnf$1", "symbols": ["n$ebnf$1", "n$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "n", "symbols": ["n$ebnf$1"], "postprocess": d => null},
    {"name": "nn$ebnf$1$subexpression$1", "symbols": [t_whitespace]},
    {"name": "nn$ebnf$1$subexpression$1", "symbols": [t_newline]},
    {"name": "nn$ebnf$1", "symbols": ["nn$ebnf$1$subexpression$1"]},
    {"name": "nn$ebnf$1$subexpression$2", "symbols": [t_whitespace]},
    {"name": "nn$ebnf$1$subexpression$2", "symbols": [t_newline]},
    {"name": "nn$ebnf$1", "symbols": ["nn$ebnf$1", "nn$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "nn", "symbols": ["nn$ebnf$1"], "postprocess": d => null}
]
  , ParserStart: "Program"
}
